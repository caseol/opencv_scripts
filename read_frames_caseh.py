...
while vct.running():
	...
	if bool(recon_faces):
		...
		print("[RECON] diff_from_last_recon > int(recon_period): " + (diff_from_last_recon > int(recon_period)) + " diff_from_last_recon: " + str(diff_from_last_recon) + " frf.last_recon_datetime: " + str(frf.last_recon_datetime))
